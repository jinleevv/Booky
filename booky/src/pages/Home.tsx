  ...
  return (
    <section className="h-screen w-screen bg-white">
      ...
      <div className="flex flex-col items-center justify-start h-5/6 relative">
        ...
        <div className="flex w-full h-4/6 items-center justify-center m-auto relative">
          <div className="absolute w-[1150px] xl:w-[1400px] 2xl:w-[1620px] h-[600px] xl:h-[680px] 2xl:h-[700px] bg-black blur-[2px] z-0 mt-16 rounded-lg"></div>

            ...
            <div className="w-full px-3 py-4 relative z-20">
              <div className="grid w-full">
                ...
                <Label className="text-xs text-gray-400">
                  Book an Appointment and View the Schedule
                </Label>
              </div>
            </div>
          </div>
          <Tabs defaultValue="appointment">
            <TabsList className="border-none p-0 bg-white">
              <TabsTrigger
                value="appointment"
                className="px-4 border-none data-[state=active]:shadow-none data-[state=active]:text-red-600"
              >
                Schedule
              </TabsTrigger>
              <span className="h-6 border-l border-gray-400 mx-1"></span>
              <TabsTrigger
                value="view"
                className="px-4 border-none data-[state=active]:shadow-none data-[state=active]:text-red-600"
              >
            ...
            <TabsContent value="appointment">
              <div className="flex relative w-full md:h-[750px] md:mt-32 sm:h-full">
                {teamName === "Not Found" ? (
                  <>
            ...
            <TabsContent value="view" className="mb-28">
              <CalenderView teamName={teamName} admin={adminName} />
            </TabsContent>
          </Tabs>
        </div>
      </div>

...
import modifyAvailableTimeRoute from "./routes/team/modifyAvailableTimeRoute";
import deleteAvailableTimeRoute from "./routes/team/deleteAvailableTimeRoute";
...
app.use("/api/teams", modifyAvailableTimeRoute);
app.use("/api/teams", deleteAvailableTimeRoute);
